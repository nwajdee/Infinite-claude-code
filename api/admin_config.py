...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        secret=True,
        description="FreeLLMAPI OpenAI-compatible API key (default http://localhost:3001/v1).",
    ),
    ConfigFieldSpec(
        "LM_STUDIO_BASE_URL",
        "LM Studio Base URL",
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="freellmapi_proxy",
        secret=True,
        advanced=True,
    ),
    ConfigFieldSpec(
    ...
    ConfigFieldSpec(
        "FCC_SMOKE_MODEL_FREELLMAPI",
        "Smoke FreeLLMAPI Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
